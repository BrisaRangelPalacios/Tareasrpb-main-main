...
def RegisterView(page: ft.Page, auth_controller):
    ...
    def registrar_click(e):
        ...
        if password.value != confirm_password.value:
            ...
            mensaje.color = ft.Colors.Purple_200
            page.update()
            return
        ...
        if exito:
            mostrar_snackbar("¡Registro exitoso! Ahora inicia sesión", ft.Colors.Purple_200)
            nombre.value = ""
            apellido.value = ""
            email.value = ""
            password.value = ""
        ...
        controls=[
            ft.Column(
                [
                    ...
                    ft.Text("Nueva Cuenta ", size=20, weight="bold", color=ft.Colors.PINK_200),
                    ft.Container(height=10),
